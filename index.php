...
<html lang="en">
	<head>
		...
		<link href='https://fonts.googleapis.com/css?family=Lato:400,300italic,100,300' rel='stylesheet' type='text/css'>
	...
	<body>
		<header>
			...
			<div class="hero-text-box">
				<h1 class="js--hello">Goodbye junk food. <br> Hello super healthy meals.</h1>
				<a class="btn btn-full js--scroll-to-plans" href="#">I&rsquo;m hungry</a>
		...
		<section class="section-cities" id="cities">
			...
			<div class="row js--wp-3">
				...
				<div class="col span-1-of-4 box">
					...
					<div class="city-feature">
						<i class="ion-social-twitter icon-small"></i>
						<a class="twitter-link" href="#">@omnifood_sf</a>
				...
				<div class="col span-1-of-4 box">
					...
					<div class="city-feature">
						<i class="ion-social-twitter icon-small"></i>
						<a class="twitter-link" href="#">@omnifood_berlin</a>
					</div>
				</div>
				...
				<div class="col span-1-of-4 box">
					...
					<div class="city-feature">
						<i class="ion-social-twitter icon-small"></i>
						<a class="twitter-link" href="#">@omnifood_london</a>
					</div>
				</div>
				...
				<div class="col span-1-of-3">
					<div class="plan-box js--wp-4">
						<div>
							...
							<p class="plan-price-meals">That&rsquo;s only 13.30$ per meal</p>
						</div>
						<div>
						<ul>
							<li><i class="ion-ios-checkmark-empty icon-small"></i> v1 meal every day</li>	
				...
				<div class="col span-1-of-3">
					<div class="plan-box">
						<div>
							...
							<p class="plan-price-meals">That&rsquo;s only 14.90$ per meal</p>
						</div>
						<div>
						<ul>
					...
					<div class="plan-box">
						...
						<ul>
							...
							<li><i class="ion-ios-close-empty icon-small icon-small"></i></li>	
							<li><i class="ion-ios-checkmark-empty icon-small"></i>Free delivery</li>	
						</ul>
						</div>
						<div>
